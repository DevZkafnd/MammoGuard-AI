...
class MongoDatabase:
    ...
    async def ensure_indexes(self) -> None:
        ...
        await self.database["analyses"].create_index("imageObjectKey")
        await self.database["analyses"].create_index("heatmapObjectKey")
        ...
        await self.database["mammogram_analyses"].create_index("original_image_key")
        await self.database["mammogram_analyses"].create_index("heatmap_image_key")
        ...
        await self.database["ai_models"].create_index("storage_key")
